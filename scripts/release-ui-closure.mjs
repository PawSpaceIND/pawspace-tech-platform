...
async function main() {
  ...
  // Guest/customer-facing coverage. Customer authentication itself is tested by booking journeys;
  // this gate deliberately avoids generating OTP/customer records just to inspect controls.
  ...
  // Founder covers every staff route deeply; other roles prove RBAC-specific rendering/navigation.
