...
INSERT OR IGNORE INTO provider_capacity_profiles VALUES ('uatcap_groom_ft','blr','PawSpace Grooming Team (UAT)','full_time','["grooming"]','["blr-east","blr-south","blr-north","blr-west","blr-central"]',1,4.9,97,1,30,20,3,'active',1,'2026-01-01',NULL,'uat_staging_seed',1785542400000);
INSERT OR IGNORE INTO provider_capacity_profiles VALUES ('uatcap_groom_cm','blr','PawSpace Grooming Partner (UAT)','commission','["grooming"]','["blr-east","blr-south","blr-north","blr-west","blr-central"]',1,4.8,93,1,30,20,60,'active',1,'2026-01-01',NULL,'uat_staging_seed',1785542400000);

-- Dog training (recurring): full-time so meet-and-greet + programme assign immediately.
INSERT OR IGNORE INTO provider_capacity_profiles VALUES ('uatcap_train_ft','blr','PawSpace Training Team (UAT)','full_time','["dog_training"]','["blr-east","blr-south","blr-north","blr-west","blr-central"]',1,4.9,95,1,45,12,3,'active',1,'2026-01-01',NULL,'uat_staging_seed',1785542400000);

-- Boarding (host): overnight capacity for a few guest pets, city-wide.
INSERT OR IGNORE INTO provider_capacity_profiles VALUES ('uatcap_host_cm','blr','PawSpace Boarding Host (UAT)','commission','["boarding"]','["blr-east","blr-south","blr-north","blr-west","blr-central"]',1,4.9,96,4,0,12,60,'active',1,'2026-01-01',NULL,'uat_staging_seed',1785542400000);

-- Pet sitting: city-wide visits.
INSERT OR IGNORE INTO provider_capacity_profiles VALUES ('uatcap_sit_cm','blr','PawSpace Sitter (UAT)','commission','["pet_sitting"]','["blr-east","blr-south","blr-north","blr-west","blr-central"]',1,4.8,92,4,30,12,60,'active',1,'2026-01-01',NULL,'uat_staging_seed',1785542400000);

-- Dog walking: recurring, city-wide.
INSERT OR IGNORE INTO provider_capacity_profiles VALUES ('uatcap_walk_ft','blr','PawSpace Walker (UAT)','full_time','["dog_walking"]','["blr-east","blr-south","blr-north","blr-west","blr-central"]',1,4.9,96,1,20,20,3,'active',1,'2026-01-01',NULL,'uat_staging_seed',1785542400000);

-- Pet taxi: full-time, city-wide.
INSERT OR IGNORE INTO provider_capacity_profiles VALUES ('uatcap_taxi_ft','blr','PawSpace Pet Taxi (UAT)','full_time','["pet_taxi"]','["blr-east","blr-south","blr-north","blr-west","blr-central"]',1,4.9,96,1,20,16,3,'active',1,'2026-01-01',NULL,'uat_staging_seed',1785542400000);
