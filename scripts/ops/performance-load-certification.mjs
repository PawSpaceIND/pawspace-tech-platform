...
if(process.env.PERFORMANCE_LOAD_HOSTED==="true"){
  for(const key of["STAGING_URL","PAWSPACE_UAT_SIGNING_KEY","RAZORPAY_WEBHOOK_SECRET_SANDBOX"])if(!process.env[key])throw new Error(`${key} is required for hosted performance certification`);
