 ...
 */
export const PROVIDER_SCOPED_API_PATHS=new Set(["/api/boarding-proof","/api/boarding-stays","/api/booking-operations","/api/food-proof","/api/grooming-lifecycle","/api/grooming-payment-sandbox","/api/grooming-route","/api/location-recovery","/api/partner-grooming-jobs","/api/partner-job-feed","/api/partner-jobs","/api/partner-heartbeat","/api/provider-assignment-recovery","/api/provider-availability","/api/provider-chat","/api/provider-lms","/api/provider-safety-flag","/api/service-media","/api/service-media/upload","/api/sitting-lifecycle","/api/sitting-proof","/api/taxi-adjustments","/api/taxi-lifecycle","/api/taxi-proof","/api/taxi-recovery","/api/training-provider-earnings","/api/training-session-media","/api/training-sessions","/api/walking-lifecycle","/api/walking-proof","/api/walking-recovery"]);
