...
export async function requiredPermission(request:Request):Promise<Permission|null>{const url=new URL(request.url),method=request.method.toUpperCase();if(url.pathname==="/api/pricing-quote"||url.pathname==="/api/training-commercial"||url.pathname==="/api/training-trainers"||url.pathname==="/api/boarding-commercial"||url.pathname==="/api/sitting-commercial"||url.pathname==="/api/taxi-commercial"||url.pathname==="/api/food-commercial"||url.pathname==="/api/walking-commercial"||url.pathname==="/api/razorpay-webhook"||url.pathname==="/api/haptik"||url.pathname==="/api/whatsapp-uat-webhook"||url.pathname==="/api/identity-session"||url.pathname==="/api/service-availability"||url.pathname==="/api/public-contact"||url.pathname==="/api/provider-public-profile"||url.pathname==="/api/staging-login"
  ...
  if(url.pathname==="/api/accounts-business-view")return "dashboard.view";
  if(url.pathname==="/api/acquisition-funnel")return "dashboard.view";
  if(url.pathname==="/api/ai-analytics")return "dashboard.view";
  if(url.pathname==="/api/ai-bootstrap")return "dashboard.view";
  if(url.pathname==="/api/ai-business-configuration")return "dashboard.view";
  if(url.pathname==="/api/ai-conversation")return "dashboard.view";
  if(url.pathname==="/api/ai-human-handoff")return "dashboard.view";
  if(url.pathname==="/api/ai-rollout")return "dashboard.view";
  if(url.pathname==="/api/ai-tools")return "dashboard.view";
  if(url.pathname==="/api/ai-voice-uat")return "dashboard.view";
  if(url.pathname==="/api/ai-web-chat")return "dashboard.view";
  if(url.pathname==="/api/attendance-leave")return "dashboard.view";
  if(url.pathname==="/api/cash-flow-statement")return "dashboard.view";
  if(url.pathname==="/api/catalogue")return "dashboard.view";
  if(url.pathname==="/api/customer-business-view")return "dashboard.view";
  if(url.pathname==="/api/customer-reminders")return "dashboard.view";
  if(url.pathname==="/api/customer-targeting")return "dashboard.view";
  if(url.pathname==="/api/employee-performance")return "dashboard.view";
  if(url.pathname==="/api/finance-intelligence")return "dashboard.view";
  if(url.pathname==="/api/growth-intelligence")return "dashboard.view";
  if(url.pathname==="/api/gst-accounting")return "dashboard.view";
  ...
  if(url.pathname==="/api/provider-verification")return "dashboard.view";
  if(url.pathname==="/api/revenue-recognition")return "dashboard.view";
  ...
  if(url.pathname==="/api/team-overview")return "dashboard.view";
  if(url.pathname==="/api/voice-providers")return "dashboard.view";
  if(url.pathname==="/api/voice-speech")return "dashboard.view";
