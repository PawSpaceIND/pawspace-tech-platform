...
export const defaultRoles = [
  ...
  { code:"finance", name:"Finance", description:"Payment, refund, invoice, payroll and reconciliation access without customer contact exposure.", permissions:["dashboard.view","payments.view","payments.manage","finance.view","finance.manage","compensation.view","compensation.manage","payroll.view","payroll.manage","payroll.approve","reports.view","audit.view"] },
