...
type BoardingStayScope={providerId?:string|null;cityId?:string|null;zoneId?:string|null;customerId?:string|null;bookingId?:string|null};
...
export async function loadCustomerBoardingStay(bookingId:string){return loadOwnedBoardingStay(bookingId);}
