...
export async function saveGovernedCoupon(campaign:Omit<CouponCampaign,"createdAt"|"updatedAt"|"testOnly">&{id?:string}){return payload(await fetch("/api/coupon-governance",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({action:"save_campaign",campaign})})) as Promise<CouponCampaign>;}
