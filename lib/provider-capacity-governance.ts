...
const defaults=[
  ...
  {id:"host_sana",cityId:"blr",name:"Sana F.",model:"commission",services:["boarding"],zones:["blr-south"],rating:4.8,qualityScore:92,capacity:3,travelBufferMinutes:0,maxDailyJobs:10,acceptanceTimeoutMinutes:3},
  {id:"host_arjun_tara",cityId:"blr",name:"Arjun & Tara",model:"commission",services:["boarding"],zones:["blr-south"],rating:4.7,qualityScore:89,capacity:3,travelBufferMinutes:0,maxDailyJobs:10,acceptanceTimeoutMinutes:3},
