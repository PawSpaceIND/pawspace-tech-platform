...
test("P1-04-A01 a post-commit failure names the booking instead of denying it", async () => {
  ...
  const start = code.indexOf("}catch{setScheduleError(committedBookingId?");
  ...
  assert.doesNotMatch(handler, /error\.message|reason/, "raw backend errors cannot be rendered");
});
