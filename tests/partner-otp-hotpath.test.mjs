...
test('verified partner OTP clears a prior staff persona cookie',async()=>{
 const{db}=world(false);Object.assign(globalThis.__PARTNER_OTP_HOTPATH_ENV__,{PAWSPACE_UAT_LOGIN:'on',PAWSPACE_UAT_SIGNING_KEY:crypto.randomUUID()+crypto.randomUUID()});
