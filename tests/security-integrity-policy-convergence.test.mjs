...
test("platform-session authorization derives permission from the gateway decision",()=>{
  ...
  assert.match(sessionGateway,/const permission=await requiredPermission\(request\)/);
