...
test("case API enforces read/manage permissions and audits mutations",()=>{const src=read("app/api/unified-cases/route.ts");assert.ok(src.includes('authorize(request,"bookings.manage")'));assert.ok(!src.includes('authorize(request,"bookings.view")'));assert.ok(src.includes("securityAudit"));assert.ok(src.includes("productionReady:false"));});
