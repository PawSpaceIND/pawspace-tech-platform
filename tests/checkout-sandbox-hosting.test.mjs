...
for(const key of ["RELEASE_PREVIEW_D1_ID","RELEASE_PREVIEW_WORKER_NAME","RAZORPAY_WEBHOOK_SECRET_SANDBOX","RAZORPAY_KEY_SECRET_SANDBOX","PAWSPACE_UAT_ACCESS_CODE","PAWSPACE_UAT_SIGNING_KEY","PAWSPACE_IDENTITY_ASSERTION_SECRET_UAT"]){
