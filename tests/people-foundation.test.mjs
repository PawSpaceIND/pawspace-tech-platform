...
test("People UI is no longer an Operations alias and does not claim payroll readiness",()=>{const page=read("app/team/people/page.tsx");assert.ok(!page.includes("../../ops/page"));assert.match(page,/Employee and employment system of record/);assert.match(page,/Payroll implemented:<\/b> NO/);assert.match(page,/Production ready:<\/b> NO/);});
