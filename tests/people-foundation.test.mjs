...
test("People UI reflects Gates 1-4 UAT status without claiming statutory or production readiness",()=>{const page=read("app/team/people/page.tsx");assert.ok(!page.includes("../../ops/page"));assert.match(page,/Employee and employment system of record/);assert.match(page,/People Gates 1–4:<\/b> IMPLEMENTED FOR UAT/);assert.match(page,/Statutory\/live bank:<\/b> NOT ENABLED/);assert.match(page,/Production ready:<\/b> NO/);});
