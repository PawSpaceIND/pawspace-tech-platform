...
test("stay-flow offers the governed 50/50 option for overnight stays longer than 4 nights, both modes", () => {
  ...
  assert.match(flow, /createSittingQuote\(\{packageCode,petCount:selectedPets\.length,cityId:serviceLocation\.assignment\.cityId,zoneId:serviceLocation\.assignment\.zoneId,scheduledStart:scheduledStart\.toISOString\(\),scheduledEnd:scheduledEnd\.toISOString\(\),paymentMode,providerId:selectedSitter\?\.providerId\}\)/);
