...
test("all requested Phase 2 vertical tools are registered",()=>{
 const expected=["ops.voice.dispatch","ops.inventory.check","ops.fleet.track","ops.provisioning.execute","marketing.ads.read_metrics","marketing.proposal.submit","marketing.ads.budget.reallocate","marketing.ads.keyword.mutate","finance.yield.calculate_surge","finance.ledger.reconcile","vet.triage.evaluate","vet.prescription.digitize","finance.vet_payout.calculate"];
