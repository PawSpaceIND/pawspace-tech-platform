...
if(process.env.STAGING_URL?.replace(/\/$/,'')!==origin||!process.env.PAWSPACE_UAT_ACCESS_CODE)throw new Error('Exact staging origin and UAT credential required');
