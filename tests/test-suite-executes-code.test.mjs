 ...
 *
 * 175 of this suite's 522 test files (34%) never execute a single line of lib/ or app/ code - they
...
const MODULE_PATH = /["'`]\.\.\/(lib|app)\//;
const HARNESS = /installWorkersHooks/;
const executes = (src) =>
  STATIC_IMPORT.test(src) || HARNESS.test(src) || (DYNAMIC_IMPORT.test(src) && MODULE_PATH.test(src));
