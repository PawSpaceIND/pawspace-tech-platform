...
for(const kind of ["overlap","buffer","daily","leave","inactive","roster"])test(`replacement refuses concurrent ${kind} conflict and preserves original assignment`,async t=>{
