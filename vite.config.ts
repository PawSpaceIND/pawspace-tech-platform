...
const localBindingConfig = {
  ...
  ratelimits:[
    {name:"PUBLIC_CONTACT_RATE_LIMITER",namespace_id:"1001",simple:{limit:100,period:60 as const}},
    {name:"AI_VOICE_RATE_LIMITER",namespace_id:"1002",simple:{limit:100,period:60 as const}},
  ],
  d1_databases: d1
    ? [
        {
