...
export default function TrainingPage(){
 ...
 useEffect(()=>{
  ...
  void Promise.all([
   ...
   setError("");
  }).catch(problem=>{if(active)setError(problem instanceof Error?problem.message:"Unable to load Training availability")});
  return()=>{active=false};
