...
export default function ContactForm(){
  ...
  return <form onSubmit={onSubmit} style={{display:"grid",gap:14}}>
    <div style={{display:"grid",gap:14,gridTemplateColumns:"1fr 1fr"}}><label>Your name<input name="name" required minLength={2} placeholder="e.g. Ananya Rao" style={inputStyle}/></label><label>Phone number<input name="phone" type="tel" required pattern="[0-9+\s\-]{10,15}" title="10-15 digits; + spaces and hyphens are allowed" placeholder="98765 43210" style={inputStyle}/></label></div>
