        ...
        {view === "crm" && <>
          ...
          <section className={styles.crmLayout}>
            ...
            <aside className={styles.customer360}>
              <div className={styles.customer360Head}><span>{selectedCustomer.initials}</span><div><small>{selectedCustomer.id}</small><h2>{selectedCustomer.name}</h2><p>{selectedCustomer.primary} · {selectedCustomer.zone}</p></div><button disabled title="Additional customer actions are not connected">•••</button></div>
