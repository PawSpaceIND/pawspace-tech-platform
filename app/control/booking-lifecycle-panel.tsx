...
import ServiceWindowOverride from "./service-window-override";
...
export default function BookingLifecyclePanel(){
  ...
  return <div className={styles.wrap}>
    ...
    <ServiceProofReview title="Service proof awaiting review" />
