...
export default function TestSyncPanel({surface}:{surface:Surface}){
  ...
  const cancelCustomer=async()=>{
    ...
    return updateTestTransaction({status:"cancelled",paymentStatus:paymentStatus as TestTransaction["paymentStatus"],crmNextAction:"Service recovery follow-up"},"customer","Customer cancelled; canonical capacity and reserved credit released");
  };
