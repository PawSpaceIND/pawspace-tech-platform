...
export default function PawSpaceAppearance() {
  ...
  return <>
    ...
    <dialog ref={dialog} className="paw-appearance-dialog" aria-labelledby="paw-appearance-title">
      ...
      }}/><span><b>{style === "professional" ? "Professional" : "Cartoon"}</b><small>{style === "professional" ? "Clean care essentials · default" : "Playful illustrated companion · alternative"}</small></span></label>)}</fieldset>
