  ...
  return (
    <main className="app-shell">
      ...
      <header className="topbar">
        ...
        <div className="header-links"><Link href="/mobile-app">Mobile App</Link><Link href="/grooming">Grooming</Link><Link href="/food">Fresh Food</Link><Link href="/boarding">Boarding</Link><Link href="/sitting">Pet Sitting</Link><Link href="/taxi">Pet Taxi</Link><Link href="/walking">Dog Walking</Link><Link href="/training">Training</Link><Link href="/relocation">Pet Relocation</Link><Link href="/funeral-memorial">Funeral &amp; Memorial</Link><Link href="/mobile-app">My PawSpace</Link>{customer ? <Link className="login-link" href="/mobile-app">{customer.customerName}</Link> : <a className="login-link" href="#customer-login-modal">Login</a>}</div>
      </header>
