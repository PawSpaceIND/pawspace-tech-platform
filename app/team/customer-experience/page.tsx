            ...
            {visible.length === 0 ? (
              ...
              return (
                ...
                >
                  ...
                  {comm ? <div className={`${styles.communicationFlag} ${comm.state === "failed" ? styles.communicationFlagFailed : styles.communicationFlagPending}`} role="status"><b>{text(comm.label)}</b>{comm.state === "failed" ? <span>Communication Pending · staff follow-up required</span> : null}<span>Booking {text(comm.bookingId)} · customer may not know payment succeeded</span></div> : null}
