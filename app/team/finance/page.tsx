    ...
    <div className={styles.shell}>
      ...
      {data&&!loading&&<>
        ...
        <section style={{background:"white",border:"1px solid #e5dcef",borderRadius:14,overflow:"hidden"}}>
          <div style={{padding:"16px 18px",borderBottom:"1px solid #eee6f5",display:"flex",justifyContent:"space-between",gap:12,flexWrap:"wrap"}}><b>Canonical transactions</b><small>{data.source}</small></div>
          <div className={styles.tableScroller}><table className={styles.ledgerTable}><thead><tr>{["Booking","Package","Booking","Payment","Gateway","Reconciliation","Captured","Refunded","Variance","Invoice","Subscription"].map(h=><th key={h} style={{textAlign:"left",padding:"12px 12px",background:"#faf8fc",borderBottom:"1px solid #eee6f5",whiteSpace:"nowrap"}}>{h}</th>)}</tr></thead><tbody>
