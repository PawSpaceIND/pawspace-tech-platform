...
export default function StayFlow({ mode: initialMode, customer, location }: { mode: Mode; customer: LoggedInCustomer; location: ResolvedLocation }) {
      ...
      {stage === 1 && (
        <>
          ...
          <label className={styles.field}>
            Service zone
            <select value={`${location.city} · ${location.zoneId}`} disabled>
              <option>{`${location.city} · ${location.zoneId}`}</option>
            </select>
          </label>
