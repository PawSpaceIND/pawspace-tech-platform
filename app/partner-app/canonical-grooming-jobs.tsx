  ...
  return <div className={styles.board}>
    ...
    <section style={{background:"white",border:"1px solid #eadff4",borderRadius:18,padding:22}}>
      {!selected?<div style={{padding:30,textAlign:"center",color:"#746b7d"}}>Select a canonical work order.</div>:<>
        ...
        {["arrived", "in_service"].includes(selected.status) && <GroomingUpload key={selected.bookingId} bookingId={selected.bookingId} />}
        <p><a href={`/team/operations/media-review?bookingId=${encodeURIComponent(selected.bookingId)}`}>Internal photo review · separate reviewer sign-in required</a></p>
