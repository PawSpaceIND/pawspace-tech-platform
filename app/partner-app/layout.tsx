export default function PartnerMobileLayout({children}:{children:React.ReactNode}){
  return <>
    <div role="status" style={{padding:"8px 14px",borderBottom:"1px solid #dcece5",background:"#fffaf0",color:"#62451a",fontFamily:"system-ui",fontSize:11,lineHeight:1.4,textAlign:"center"}}>
