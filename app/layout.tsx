...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body className="antialiased"><MobileNetworkStatus /><MobilePushListener /><MobileDeepLinkHandler /><ReviewUxFixes />{children}<PawSpaceAppearance /><OrderNotificationCenter /></body></html>;
}
