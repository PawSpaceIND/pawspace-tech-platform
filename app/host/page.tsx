...
import{ReadRefusedNotice}from"../components/refused-surface";
...
export default function HostPage(){
 ...
 return <main className={styles.shell}>
  ...
  <section className={styles.main}>
   ...
   {/* R3-G / F6: "Current guests 0 · Accepted stays 0 · Recovery queue 0" rendered from an empty
       array beside the refusal, telling a host their home is empty when in fact nothing was read. */}
   <ReadRefusedNotice error={error} what="your host workspace" />
   {loading&&<section className={styles.panel}><p>Loading governed Boarding stays…</p></section>}
   {!error&&!loading&&tab==="today"&&<>
   ...
   {!error&&!loading&&tab==="requests"&&<section className={styles.requestLayout}>
