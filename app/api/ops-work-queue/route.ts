...
function emptyWorkQueueSnapshot(){return{generatedAt:Date.now(),metrics:{total:0,open:0,escalated:0,critical:0,resolvedToday:0},queues:{},commandCentre:{available:false},truth:{source:"canonical tables only",detectors:["provider_unassigned","refund_requested","refund_failed","payment_exception","low_rating_callback","relocation_enquiry","food_renewal_payment_overdue","lead_response_overdue"],backgroundSchedulerConfigured:false,productionReady:false}};}
